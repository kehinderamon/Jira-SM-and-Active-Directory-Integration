...
Tech stack
Python 3
`ldap3`  pure-Python LDAP client for talking to Active Directory
`requests`  Jira Cloud REST API v3 calls
...
A JSM project (see the Jira Service Management Ticket Toolkit project for how to get your API token and project key  this project reuses the exact same `jsm\_client.py`)
2. Install
```bash
